(() => {
  ...
  const rows = sessionKey === "session01" ? [
    ["우리에게는","아주","좋은","친구가","있어요"],
    ["그 친구는","우리와","전혀","다르게","생겼어요"],
    ["나는","코뿔소예요","작은","벌레들이","괴롭혀요"],
    ["새는","벌레를","모두","잡아","주지요"],
    ["음식을 먹고","이빨을","깨끗이","청소해","주지요"]
  ] : [
    ["기린이에요","가렵지만","긁을","동물이","즐거워요"],
    ["긁어","얼룩말이에요","듣는","위험한","친구니까요"],
    ["생겼지만","상관없어요","기린이에요","가렵지만","동물이"],
    ["얼룩말이에요","위험한","긁을","긁어","듣는"],
    ["생겼지만","상관없어요","즐거워요","친구니까요","가렵지만"]
  ];
