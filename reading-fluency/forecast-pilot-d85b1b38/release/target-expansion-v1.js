(() => {
  ...
  // 받침이 있으면 「과」, 없으면 「와」. 「굴뚝을와」처럼 나가던 것을 바로잡는다.
  // 마지막 글자가 한글이 아니면(부호·숫자) 「와」로 둔다.
