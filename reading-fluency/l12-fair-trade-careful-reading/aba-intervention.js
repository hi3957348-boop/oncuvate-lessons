(() => {
  ...
  if (document.getElementById("transferCard")) {
    const tasks = [
      {
        label: "어휘 전이",
        passage: "학교 나눔 장터에서 유나는 직접 만든 책갈피를 팔았습니다. 친구들은 재료비와 수고를 생각해 알맞은 대가를 지불했고, 유나는 그 돈으로 새 재료를 샀습니다.",
        question: "이 글에서 ‘정당한 대가’에 해당하는 것은 무엇인가요?",
        answers: [
          { value: "fair", text: "친구들이 재료비와 수고를 생각해 알맞은 대가를 지불한 것" },
          { value: "material", text: "유나가 새 재료를 산 것" },
          { value: "place", text: "학교에서 장터를 연 것" }
        ],
        answer: "fair",
        cueQuestion: "‘정당한 대가’의 뜻을 보여 주는 표현을 본문에서 누르세요.",
        cues: [
          { value: "place", text: "학교 나눔 장터에서" },
          { value: "fair", text: "재료비와 수고를 생각해 알맞은 대가를 지불했고" },
          { value: "material", text: "새 재료를 샀습니다" }
        ],
        cue: "fair",
        retry: "재료비와 수고를 생각해 누가 누구에게 알맞은 대가를 지불했는지 확인해 보세요.",
        explanation: "만든 사람의 재료비와 수고를 생각해 알맞은 대가를 지불한 것이 ‘정당한 대가’에 해당해요."
      },
      {
        label: "전략 전이",
        ...
        question: "민호가 B 공책을 고른 결정적인 조건은 무엇인가요?",
        answers: [
        ...
        cue: "evidence",
        retry: "결과가 아니라 민호가 선택할 때 확인한 조건을 찾아보세요.",
        explanation: "가격만 보지 않고 재료와 생산 정보를 확인하는 전략을 새 글에도 적용했어요."
      },
      {
        label: "생활·교과 전이",
        passage: "가족이 바나나를 사려 합니다. 첫 상품은 ‘착한 상품’이라는 광고만 있고 생산 정보가 없습니다. 둘째 상품은 정해진 노동·환경 기준을 확인받았다는 설명과 인증 표시가 있습니다. 가족에게 필요한 양은 한 묶음입니다.",
        ...
        cues: [
          ...
          { value: "checked", text: "정해진 노동·환경 기준을 확인받았다는 설명과 인증 표시가 있습니다" },
