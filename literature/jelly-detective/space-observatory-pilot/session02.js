window.SPACE_SESSION={
  ...
  caseLines:[
    ...
    ['UNRESOLVED QUESTION','Which planet must be removed from the landing route? Compare every scan by asking the same two questions: What is it made of? What is its surface like?']
  ],
  ...
  reading:{title:'Rocky Planets and Giant Planets',context:'You scanned four planets and removed Jupiter from the route. Now read why rocky planets and giant planets are different, so you can explain your decision.',easy:[
    'The planets in our solar system are not all alike.','Venus, Earth, and Mars are rocky planets with solid surfaces.','Jupiter is a giant planet made mostly of gas and liquid.','A spacecraft can fly near Jupiter, but it cannot land on a solid surface there.','Scientists compare different places using the same features before they choose a mission destination.'
  ],challenge:[
  ...
  ],answer:'surface',hint:'Read sentence 2 of the paragraph again: rocky planets have solid ____s. The word starts with s and means 표면.'},
