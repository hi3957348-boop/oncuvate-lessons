window.SPACE_SESSION={
  ...
  words:[["surface", "the outside layer · 표면 : 물체의 겉을 이루는 부분", "The rover needs a solid surface to land on.", ["surface", "surfaces"], "sur·face [서피스] · c가 「ㅅ」"], ["rocky", "made mostly of rock · 암석으로 된 : 주로 돌이나 바위로 이루어진", "Mars is a rocky planet.", ["rocky"], "rock·y [라키]"], ["giant", "something much larger · 거대한 : 크기가 매우 큰", "Jupiter is a giant planet.", ["giant", "giants"], "gi·ant [자이언트] · g가 「ㅈ」"], ["compare", "look for the same and different parts · 비교하다 : 둘 이상의 같은 점과 다른 점을 살펴보다", "We compare the planets using the same questions.", ["compare", "compares", "comparison"], "com·pare [컴페어]"], ["probe", "a machine sent to explore space · 탐사선 : 우주를 조사하러 보내는 기계", "The probe must land on solid ground.", ["probe", "probes"], "probe [프로브] · 끝의 e는 소리가 없어요"], ["destination", "the place you are going to · 목적지 : 가려고 하는 곳", "One destination has no solid ground.", ["destination", "destinations"], "des·ti·na·tion [데스티네이션]"], ["remain", "to stay or be left · 남다", "Only the scan records remain.", ["remain", "remains"], "re·main [리메인]"], ["sample", "a small piece taken to study · 표본 : 조사하려고 조금 떼어 낸 것", "The probe collects a rock sample.", ["sample", "samples"], "sam·ple [샘플]"], ["route", "the way you travel · 경로 : 가는 길", "Which planet must leave the route?", ["route"], "route [루트] · ou는 「우」"], ["solid", "hard, not liquid or gas · 단단한 : 액체나 기체가 아닌", "Mars has a solid surface.", ["solid"], "sol·id [살리드]"], ["liquid", "something that flows, like water · 액체", "Jupiter is made mostly of gas and liquid.", ["liquid"], "liq·uid [리퀴드] · qu는 「쿠」"], ["mission", "an important job to do · 임무 : 맡은 중요한 일", "This mission needs a place to land.", ["mission", "missions"], "mis·sion [미션] · ss는 「ㅅ」"], ["feature", "one part of what something is like · 특징", "Scientists compare the same features.", ["feature", "features"], "fea·ture [피처]"], ["temperature", "how hot or cold something is · 온도", "Planets can be compared by their temperatures.", ["temperature", "temperatures"], "tem·per·a·ture [템퍼러처]"], ["category", "a group of things that go together · 분류 항목 : 같은 종류끼리 묶은 칸", "Use the same comparison categories.", ["category", "categories"], "cat·e·go·ry [캐터고리]"], ["decision", "a choice you make · 결정", "Comparing helps make a fair decision.", ["decision", "decisions"], "de·ci·sion [디시전]"], ["beneath", "under · 아래에", "The ground is solid beneath the probe.", ["beneath"], "be·neath [비니쓰] · th 소리"], ["layer", "one level on top of another · 층", "Jupiter’s outer layers are gas.", ["layer", "layers"], "lay·er [레이어]"], ["distance", "how far apart · 거리", "A probe can study Jupiter from a distance.", ["distance"], "dis·tance [디스턴스]"]],
