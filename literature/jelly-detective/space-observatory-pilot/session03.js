window.SPACE_SESSION={
  ...
  caseLines:[
    ['MISSION ALERT · LUNAR DAWN','A robotic lander stopped sending data after a cold lunar night. Its power indicator and two warning lights are red.'],
    ['SYSTEM REPORT','The battery is low, the instrument box is too cold, and the antenna is pointing away from Earth.'],
    ['UNRESOLVED QUESTION','Which controls will help restore the lander’s systems? Make a short plan, repair one system at a time, and check the result each time.']
  ],
  ...
  reading:{title:'How Machines Work on the Moon',context:'You repaired power, temperature, and communication. Now read how these systems really work on the Moon, so your mission report can explain each repair.',easy:[
  ...
  ],answer:'check',hint:'Look at strategy step 3: 결과 확인. The word means 확인하다 and starts with c. Your sentence frame also says “Finally, I ____ed…”.'},
