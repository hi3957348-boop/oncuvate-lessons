window.SPACE_SESSION={
  ...
  words:[["power", "energy used to run a machine · 전력 : 기계를 움직이거나 작동시키는 데 쓰는 에너지", "The solar panel provides power to the lander.", ["power"], "pow·er [파워]"], ["insulate", "protect from heat or cold · 단열하다 : 열이 들어오거나 나가는 것을 막다", "The cover helps insulate the instrument box.", ["insulate", "insulated"], "in·su·late [인설레이트]"], ["antenna", "a part that sends or receives signals · 안테나 : 신호를 보내거나 받는 장치", "The antenna sends data toward Earth.", ["antenna", "antennas"], "an·ten·na [앤테나]"], ["sequence", "an order of steps · 순서 : 일이 이루어지는 앞뒤의 차례", "The team followed a short repair sequence.", ["sequence"], "se·quence [시퀀스] · qu는 「쿠」"], ["lunar", "about the Moon · 달의", "The lunar night is very cold.", ["lunar"], "lu·nar [루너]"], ["instrument", "a tool for measuring · 기구 : 재거나 조사하는 도구", "The instrument box is too cold.", ["instrument", "instruments"], "in·stru·ment [인스트루먼트]"], ["atmosphere", "the air around a planet · 대기 : 행성을 둘러싼 공기", "The Moon has almost no atmosphere.", ["atmosphere"], "at·mos·phere [앳머스피어] · ph는 「ㅍ」"], ["electricity", "energy that runs lights and machines · 전기", "Solar panels make electricity.", ["electricity", "electrical"], "e·lec·tric·i·ty [일렉트리시티]"], ["signal", "a message sent by radio · 신호", "Earth receives no signal.", ["signal", "signals"], "sig·nal [시그널]"], ["repair", "to fix · 수리하다", "Repair one system at a time.", ["repair", "repairs", "repaired"], "re·pair [리페어]"], ["restore", "to bring back to working · 복구하다 : 다시 되게 하다", "Which controls will restore the mission?", ["restore", "restored"], "re·store [리스토어]"], ["result", "what happens after you do something · 결과", "Check every result.", ["result", "results"], "re·sult [리절트]"], ["control", "a button or switch that runs a machine · 조작 장치", "Test one control in each system.", ["control", "controls"], "con·trol [컨트롤]"], ["verify", "to check that it is true · 확인하다", "Mission teams verify each result.", ["verify"], "ver·i·fy [베리파이]"], ["convert", "to change into another form · 바꾸다", "Solar panels convert sunlight into energy.", ["convert"], "con·vert [컨버트]"], ["protection", "keeping safe · 보호", "Machines have little natural protection on the Moon.", ["protection"], "pro·tec·tion [프러텍션]"], ["several", "more than two · 여러", "Landers need several connected systems.", ["several"], "sev·er·al [세버럴]"], ["difficult", "hard to do · 어려운", "The Moon is a difficult place for machines.", ["difficult"], "dif·fi·cult [디피컬트]"], ["receive", "to get · 받다", "Earth receives the signal.", ["receive", "receives"], "re·ceive [리시브] · ei는 「이」"], ["communication", "sending and getting messages · 통신", "The communication system was restored.", ["communication"], "com·mu·ni·ca·tion [커뮤니케이션]"], ["temperature", "how hot or cold something is · 온도", "The box is below its safe temperature.", ["temperature", "temperatures"], "tem·per·a·ture [템퍼러처]"], ["compartment", "a closed section inside · 칸 : 안이 나뉜 한 공간", "Insulated compartments slow heat loss.", ["compartment", "compartments"], "com·part·ment [컴파트먼트]"]],
