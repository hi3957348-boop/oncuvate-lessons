window.CASE_SESSION={
  ...
  goal:{question:['What is the best watch goal?','가장 알맞은 점검 목표는 무엇일까요?'],correct:'deliver',choices:[
    ...
    ['deliver','Plan, check, and fix the three stations so every warning reaches the bridge.','세 자리를 계획하고 점검해 모든 경고가 함교에 닿게 한다.'],
    ['photo','Take a picture of the iceberg.','빙산 사진을 찍는다.']
  ]},
  words:[["receive", "to get something that is sent · 받다 : 보내온 것을 손에 넣다", "The wireless room received another ice warning.", ["receive", "received"], "re·ceive"], ["several", "more than two, but not many · 여럿 : 두셋보다 많은", "Several ships reported ice that day.", ["several"], "sev·er·al"], ["calm", "still and quiet · 잔잔한 : 움직임이 없이 고요한", "The sea was very calm that night.", ["calm"], "calm"], ["station", "a place where one job is done · 자리 : 한 가지 일을 맡아 하는 곳", "Check one station at a time.", ["station", "stations"], "sta·tion"], ["bridge", "the room from which the captain steers the ship · 함교 : 선장과 항해사가 배를 조종하는 방", "The lookout phoned the bridge.", ["bridge"], "bridge"], ["lookout", "a person who watches for danger · 망보는 사람 : 위험이 없는지 살피는 사람", "The lookouts watched for ice from the crow’s nest.", ["lookout", "lookouts"], "look·out"], ["binoculars", "a tool with two tubes that makes far things look close · 쌍안경", "The lookouts had no binoculars.", ["binoculars"], "bin·oc·u·lars"], ["wireless", "a radio machine that sent messages without wires · 무선 전신 : 전선 없이 소식을 보내는 기계", "The wireless room received the warning.", ["wireless"], "wire·less"], ["operator", "a person who runs a machine · 기사 : 기계를 다루는 사람", "The wireless operator was very busy.", ["operator", "operators"], "op·er·a·tor"], ["telegram", "a message sent by wireless or wire · 전보 : 전신으로 보내는 짧은 소식", "He had a big stack of passenger telegrams.", ["telegram", "telegrams"], "tel·e·gram"], ["deliver", "to carry something to the right place · 전달하다 : 가야 할 곳까지 가져다주다", "Two warnings were never delivered to the bridge.", ["deliver", "delivered"], "de·liv·er"], ["steer", "to turn a ship in a direction · 조종하다 : 배의 방향을 잡다", "Steer farther south, away from the ice.", ["steer", "steering"], "steer"], ["course", "the way a ship travels · 항로 : 배가 가는 길", "The captain changed the ship’s course.", ["course"], "course"], ["farther", "a longer way · 더 멀리", "The Titanic would travel farther south.", ["farther"], "far·ther"], ["reduce", "to make less · 줄이다", "He did not reduce the ship’s speed.", ["reduce"], "re·duce"], ["officer", "a crew leader who helps the captain · 항해사 : 선장을 돕는 배의 간부", "The officer turned the wheel as far as it would go.", ["officer", "officers"], "of·fi·cer"], ["iceberg", "a huge piece of ice floating in the sea · 빙산 : 바다에 떠다니는 큰 얼음 덩어리", "The iceberg struck the ship.", ["iceberg", "icebergs"], "ice·berg"], ["struck", "hit hard · 부딪쳤다 : 세게 부딪혔다", "The Titanic struck the iceberg.", ["struck"], "struck"], ["sequence", "an order of steps · 순서 : 일이 이루어지는 앞뒤의 차례", "Turn the night into a clear sequence.", ["sequence"], "se·quence"], ["assistant", "a helper · 조수 : 곁에서 돕는 사람", "The assistant operator carried a warning to the bridge.", ["assistant"], "as·sis·tant"]],
  strategy:{labels:['짧게 계획','하나씩 실행','결과 확인'],game:'먼저 순서를 정하고 한 자리씩 점검해요',check:'세 자리의 결과가 모두 바뀌었는지 확인해요'},
  guide:{game:[
    {en:'Make a short three-step watch plan.',ko:'세 단계의 짧은 점검 계획을 세워요.'},
